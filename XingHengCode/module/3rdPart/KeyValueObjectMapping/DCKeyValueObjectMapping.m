...
- (NSArray *)serializeObjectArray:(NSArray *)objectArray ForClass: (Class) classToGenerate;
{
    NSMutableArray *serializedObjects = [[NSMutableArray alloc] init];
    ...
    for (id object in objectArray) {
        ...
        NSDictionary *dic =  [NSDictionary dictionaryWithDictionary:serializedObject];
        [serializedObjects addObject:dic];
    }
