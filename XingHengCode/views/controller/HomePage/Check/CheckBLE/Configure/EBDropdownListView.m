...
static CGFloat const kArrowImgHeight= 7;
static CGFloat const kArrowImgWidth= 12;
static CGFloat const kTextLabelX = 10;
...
- (UIImageView*)arrowImg {
    if (!_arrowImg) {
        ...
        _arrowImg.image = [UIImage imageNamed:@"arr_down"];
...
- (UITableView*)tbView {
    if (!_tbView) {
        ...
        _tbView.layer.shadowColor = RGBHex(qwColor3).CGColor;
        _tbView.layer.shadowOpacity = 0.8;
        _tbView.layer.shadowRadius = 4;
        _tbView.layer.borderColor = RGBHex(qwColor3).CGColor;
