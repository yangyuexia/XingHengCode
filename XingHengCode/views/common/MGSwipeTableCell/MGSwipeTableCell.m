...
#pragma clang diagnostic pop
    ...
    if (_cell.swipeDelegate && [_cell.swipeDelegate respondsToSelector:@selector(swipeTableCell:tappedButtonAtIndex:direction:fromExpansion:)]) {
        ...
        autoHide|= [_cell.swipeDelegate swipeTableCell:_cell tappedButtonAtIndex:index direction:fromLeft ? MGSwipeDirectionLeftToRight : MGSwipeDirectionRightToLeft fromExpansion:fromExpansion];
    }
...
- (BOOL)gestureRecognizerShouldBegin:(UIGestureRecognizer *)gestureRecognizer {
    ...
    if (gestureRecognizer == panRecognizer) {
        ...
        if (_swipeDelegate && [_swipeDelegate respondsToSelector:@selector(swipeTableCell:canSwipe:)]) {
            allowSwipeLeftToRight = [_swipeDelegate swipeTableCell:self canSwipe:MGSwipeDirectionLeftToRight];
            allowSwipeRightToLeft = [_swipeDelegate swipeTableCell:self canSwipe:MGSwipeDirectionRightToLeft];
        }
        else {
            [self fetchButtonsIfNeeded];
